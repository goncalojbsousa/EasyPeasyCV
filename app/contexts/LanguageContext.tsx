  ...
  useEffect(() => {
    try {
      ...
      if (typeof window !== 'undefined') {
        ...
        if (savedLanguage && (savedLanguage === 'pt' || savedLanguage === 'en' || savedLanguage === 'es' || savedLanguage === 'br')) {
...
const ptTranslations: Record<string, string> = {
  ...
  'preview': 'Preview',
  'live.preview.title': 'Preview ao vivo',
  'live.preview.desktop.only': 'O preview ao vivo está disponível apenas no desktop.',
  ...
  'layout.controls.header.iconSize': 'Ícones tamanho',
