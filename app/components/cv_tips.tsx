...
export function CVTips() {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 to-indigo-100 border border-blue-200 rounded-lg shadow-sm p-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-900">Dicas para um Currículo que Passe em Sistemas ATS</h2>
          <p className="text-sm text-gray-600">Siga estas recomendações para aumentar as suas hipóteses de ser selecionado</p>
        </div>
      </div>
      <div className="space-y-4">
        {tips.map((tip, index) => (
          <div key={index} className="bg-white rounded-lg p-4 border border-blue-100 shadow-sm">
            ...
            <p className="text-gray-700 text-sm ml-8">{tip.description}</p>
          </div>
        ))}
        <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-blue-800 font-medium">Dica Extra</p>
