...
export function AtsExplanation() {
	...
	return (
		<div
			id="ats-explanation-section"
			className="bg-gradient-to-br from-emerald-50 to-green-100 dark:from-emerald-900/20 dark:to-green-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg shadow-sm p-4 sm:p-6"
		>
			<div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-4">
				...
				<div>
					<h2 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-gray-100">
						{t("ats.explanation.title")}
					</h2>
					<p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
						{t("ats.explanation.subtitle")}
					</p>
				</div>
			</div>
			...
			<div className="space-y-3 sm:space-y-4">
				{atsInfo.map((info, index) => (
					<div
						key={info.id}
						className="bg-white dark:bg-zinc-900 rounded-lg p-3 sm:p-4 border border-emerald-100 dark:border-emerald-900 shadow-sm"
					>
						...
						<p className="text-gray-700 dark:text-gray-300 text-xs sm:text-sm ml-7 sm:ml-8 mb-3">
							{info.description}
						</p>
