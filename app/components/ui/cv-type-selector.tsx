...
export function CVTypeSelector() {
  ...
  const getCurrentCVTypeName = () => {
    return t(`cv.type.${cvType}`);
  };
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <span className="hidden sm:inline text-sm font-medium">{getCurrentCVTypeName()}</span>
        <svg 
      ...
      {isOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-zinc-800 rounded-lg shadow-xl border border-gray-200 dark:border-zinc-700 py-2 z-50">
