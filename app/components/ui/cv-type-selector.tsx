...
export function CvTypeSelector({ selectedTemplate, onTemplateChange }: CvTypeSelectorProps) {
  ...
  return (
    <div className="relative" ref={triggerRef}>
      ...
      {/* Template options dropdown via portal */}
      {isOpen && typeof document !== 'undefined' && menuRect && createPortal(
        (
          <div
            className="fixed bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-lg shadow-lg z-[1000]"
            style={{
