...
export function FormSection({ title, icon, children, actionButton }: FormSectionProps) {
  return (
    <div className="w-full bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-lg shadow-sm transition-colors duration-300">
      {/* Section header with gray background */}
      <div className="bg-gray-50 dark:bg-zinc-800 px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 dark:border-zinc-700 rounded-t-lg transition-colors duration-300">
