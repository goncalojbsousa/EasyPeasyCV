...
/**
 * Single source of truth for the four supported UI/PDF languages.
 * Used by the navbar language switcher and by every "generate PDF in language X"
 * menu (desktop bar and mobile sheet alike).
 */
export interface LanguageOption {
	code: Language;
	/** Translation key for the human-readable name */
	labelKey: string;
	/** Extra terms used when a menu is searchable */
	searchText: string;
}

export const LANGUAGE_OPTIONS: readonly LanguageOption[] = [
	{ code: "en", labelKey: "language.english", searchText: "english inglês" },
	{
		code: "pt",
...
const FLAG_TITLES: Record<Language, string> = {
	en: "English",
	pt: "Portuguese",
...
const FLAG_PATHS: Record<Language, React.ReactNode> = {
	en: (
		<>
...
/**
 * Flag icon for one of the supported languages.
 * Replaces the copies of these SVGs that previously lived in every language menu.
 */
