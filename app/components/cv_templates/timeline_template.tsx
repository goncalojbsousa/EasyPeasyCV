...
const buildStyles = (settings?: CvRenderSettings, color: CvColor = 'blue') => {
  ...
  const specificStyles = StyleSheet.create({
    ...
    headerLeft: { flex: 1 },
    name: { ...commonStyles.name, color: settings?.header.nameColor || '#0f172a', marginBottom: 8 * metrics.singlePageMult },
    ...
    photoFrame: { width: photoDimensions.width, height: photoDimensions.height, borderRadius: photoBorderRadius, alignItems: 'center', justifyContent: 'center', backgroundColor: '#f8fafc', overflow: 'hidden' },
    ...
    divider: { ...commonStyles.divider, marginTop: 10 * metrics.singlePageMult, marginBottom: 12 * metrics.singlePageMult },
    sectionTitleWrap: { flexDirection: 'row', alignItems: 'center', marginBottom: 8 * metrics.singlePageMult },
    sectionLine: { height: settings?.header.dividerThickness || 1, backgroundColor: lineColor, flex: 1, marginLeft: 8 },
    ...
    timelineWrap: { paddingLeft: 18, marginLeft: 8, borderLeftWidth: 1, borderLeftColor: lineColor },
    timelineItem: { position: 'relative', paddingLeft: 8, marginBottom: 12 * metrics.singlePageMult },
    timelineBullet: { position: 'absolute', width: 10, height: 10, borderRadius: 5, borderWidth: 2, borderColor: metrics.accent, backgroundColor: '#ffffff', left: -23.5, top: 0 },
