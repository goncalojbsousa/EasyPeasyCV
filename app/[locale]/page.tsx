...
import { ScrollReveal } from "../components/ui/scroll_reveal";
		...
		<div className="min-h-screen bg-white dark:bg-zinc-900 transition-colors">
			...
			<main id="main-content">
				...
				<section className="relative pt-24 pb-20 px-4 sm:px-6 overflow-hidden">
					...
					<div className="max-w-7xl mx-auto">
						<div className="grid lg:grid-cols-2 gap-12 items-center">
							...
							{/* Hero Image/Visual - Template preview (compact on mobile, carousel on desktop) */}
							<div className="relative lg:block">
								<div className="relative">
									...
									<section
										ref={previewRef}
										className="relative bg-white dark:bg-zinc-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-zinc-700 overflow-hidden max-w-md mx-auto lg:max-w-none"
										onMouseEnter={() => {
											setIsHovered(true);
									...
									>
										{/* Progress bar */}
										<div
											className={`absolute top-0 left-0 h-1 bg-gradient-to-r from-sky-400 to-sky-600 rounded-tl-2xl ${isProgressPaused ? "progress-bar-paused" : "progress-bar-animate"}`}
											key={`progress-${currentTplIndex}`}
										/>
										...
										<button
											...
											onClick={() =>
												setCurrentTplIndex(
													(i) =>
														(i - 1 + previewTemplates.length) %
														previewTemplates.length,
												)
											}
											className={`absolute left-3 top-1/2 -translate-y-1/2 bg-white/70 dark:bg-zinc-800/70 backdrop-blur-sm border border-gray-200 dark:border-zinc-700 text-gray-900 dark:text-white w-9 h-9 rounded-full flex items-center justify-center hover:bg-white dark:hover:bg-zinc-700 transition-opacity ${isHovered ? "opacity-100" : "opacity-0 focus:opacity-100"}`}
										...
										<button
											...
											className={`absolute right-3 top-1/2 -translate-y-1/2 bg-white/70 dark:bg-zinc-800/70 backdrop-blur-sm border border-gray-200 dark:border-zinc-700 text-gray-900 dark:text-white w-9 h-9 rounded-full flex items-center justify-center hover:bg-white dark:hover:bg-zinc-700 transition-opacity ${isHovered ? "opacity-100" : "opacity-0 focus:opacity-100"}`}
										...
										<div
											className={`absolute bottom-3 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-white/60 dark:bg-zinc-800/60 backdrop-blur-sm px-3 py-2 rounded-full border border-gray-200 dark:border-zinc-700 transition-opacity ${isHovered ? "opacity-100" : "opacity-0 focus-within:opacity-100"}`}
										>
						...
						{previewTemplates.length === 0 ? (
							...
							<>
								<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
									{previewTemplates.map((tpl) => (
										<Link
											key={tpl.key}
											href={`/${language}/builder`}
											className="group rounded-2xl overflow-hidden border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 hover:border-sky-300 dark:hover:border-sky-700 transition-all hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-zinc-900"
										>
											<div className="relative h-64 bg-gray-100 dark:bg-zinc-800 overflow-hidden">
												...
												<div className="absolute bottom-3 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity">
													<span className="inline-flex items-center gap-2 bg-sky-600 text-white px-4 py-2 rounded-lg font-semibold text-sm shadow-lg">
								...
								<div className="text-center">
									<Link
										href={`/${language}/builder`}
										className="inline-flex items-center justify-center bg-sky-600 text-white px-8 py-4 rounded-xl font-semibold shadow-lg hover:bg-sky-700 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-zinc-900 transition-all"
									>
				...
				<section className="py-20 px-4 sm:px-6 bg-gray-50 dark:bg-zinc-800 relative overflow-hidden">
					...
					<ScrollReveal className="max-w-7xl mx-auto relative">
						<div className="text-center mb-16">
					...
					<ScrollReveal className="max-w-7xl mx-auto">
						...
						<div className="grid md:grid-cols-3 gap-8 mb-16">
							<div className="group relative bg-gradient-to-br from-sky-50 to-blue-50 dark:from-zinc-800/50 dark:to-sky-900/20 p-8 rounded-2xl border border-sky-200 dark:border-sky-900/50 hover:border-sky-400 dark:hover:border-sky-700 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
								...
								<div className="text-5xl font-bold bg-gradient-to-r from-sky-600 to-blue-600 dark:from-sky-400 dark:to-blue-400 bg-clip-text text-transparent mb-3">
									100%
								</div>
								<div className="text-lg font-bold text-gray-900 dark:text-white mb-2">
									{t("landing.trust.stat1.title")}
								</div>
								<div className="text-gray-600 dark:text-gray-400 leading-relaxed">
									{t("landing.trust.stat1.description")}
								</div>
							</div>
							...
							<div className="group relative bg-gradient-to-br from-sky-50 to-blue-50 dark:from-zinc-800/50 dark:to-sky-900/20 p-8 rounded-2xl border border-sky-200 dark:border-sky-900/50 hover:border-sky-400 dark:hover:border-sky-700 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
								...
								<div className="text-lg font-bold text-gray-900 dark:text-white mb-2">
									{t("landing.trust.stat2.title")}
								</div>
								<div className="text-gray-600 dark:text-gray-400 leading-relaxed">
									{t("landing.trust.stat2.description")}
								</div>
							</div>
							...
							<div className="group relative bg-gradient-to-br from-sky-50 to-blue-50 dark:from-zinc-800/50 dark:to-sky-900/20 p-8 rounded-2xl border border-sky-200 dark:border-sky-900/50 hover:border-sky-400 dark:hover:border-sky-700 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
								...
								<div className="text-lg font-bold text-gray-900 dark:text-white mb-2">
									{t("landing.trust.stat3.title")}
								</div>
								<div className="text-gray-600 dark:text-gray-400 leading-relaxed">
									{t("landing.trust.stat3.description")}
								</div>
							</div>
						</div>
				...
				<section className="py-24 px-4 sm:px-6 bg-gray-100 dark:bg-zinc-800 relative overflow-hidden border-t border-gray-200 dark:border-zinc-800">
					<ScrollReveal className="max-w-4xl mx-auto text-center relative">
						<h2 className="text-4xl sm:text-5xl font-bold tracking-tight text-gray-900 dark:text-white mb-6">
							{t("landing.cta.title")}
						</h2>
