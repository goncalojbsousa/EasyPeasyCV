...
const enTranslations: Record<string, string> = {
	...
	"landing.trust.subtitle":
		"Numbers that speak for themselves. A tool made for you, not to profit from you.",
	"landing.trust.stat1.title": "Free",
	"landing.trust.stat1.description": "No hidden costs",
	"landing.trust.stat2.title": "Unlimited CVs",
	"landing.trust.stat2.description": "Create as many as you need",
	"landing.trust.stat3.title": "Data Sold",
	"landing.trust.stat3.description": "Privacy guaranteed",

	// Legacy Benefits
	"landing.benefits.title": "EasyPeasyCV Advantages",
	"landing.benefits.subtitle":
		"Discover why EasyPeasyCV is the right choice for your professional CV",
	...
	"landing.benefits.ats.description":
		"Our templates are optimized to pass through company applicant tracking systems (ATS).",
	...
	"landing.benefits.performance.description":
		"Generate your high-quality CV in PDF in seconds, without waiting or complications.",
	// Header
	"app.title": "EasyPeasyCV",
	"app.subtitle": "Create a professional resume in minutes",

	// Landing Page - Hero Section
	"landing.hero.badge": "Free and 100% Private",
	"landing.hero.title": "Create Your Professional CV in Minutes",
	"landing.hero.subtitle":
		"The simplest and most private way to create a professional resume. No registration, no costs, 100% in your browser.",
	...
	"landing.hero.trust":
		"No personal data is sent to servers. Everything works in your browser.",
	...
	"landing.problem.title": "Tired of Complicated Tools?",
	"landing.problem.subtitle":
		"We know what it's like searching for the perfect tool to create a resume. Do you have the same frustrations?",
	"landing.problem.item1.title": "Complex Tools",
	"landing.problem.item1.description":
		"Confusing interfaces, too many options, difficult to use. You just want to create a CV, not get a PhD.",
	"landing.problem.item2.title": "Privacy Concerns",
	"landing.problem.item2.description":
		"Upload personal data to unknown servers? No, thank you.",
	"landing.problem.item3.title": "Hidden Costs",
	"landing.problem.item3.description":
		"Start for free but then have to pay to download your own CV.",
	"landing.solution.title": "Introducing EasyPeasyCV",
	"landing.solution.description":
		"Simple, private, and completely free. Create professional resumes without complications, without sign-ups, and without costs.",
	"landing.solution.cta": "Try It Now",

	// Features Section
	"landing.features.title": "Everything You Need in One Place",
	"landing.features.subtitle":
		"Professional tools to create the perfect CV, simply and intuitively.",

	"landing.features.privacy.title": "Total Privacy",
	"landing.features.privacy.description":
		"All your data stays stored locally in your browser. Zero uploads to external servers. Complete control of your personal data.",
	"landing.features.privacy.badge": "100% Private",

	"landing.features.instant.title": "Instant Start",
	"landing.features.instant.description":
		"No registration, no emails, no passwords. Open and start creating your CV immediately.",
	...
	"landing.features.templates.description":
		"3 modern and elegant templates, all optimized for ATS systems. Choose the one that best represents your profile.",
	"landing.features.templates.badge": "3 Templates",

	"landing.features.ats.title": "ATS Optimized",
	"landing.features.ats.description":
		"All templates are compatible with applicant tracking systems used by companies.",
	"landing.features.ats.badge": "ATS-Friendly",

	"landing.features.pdf.title": "PDF Export",
	"landing.features.pdf.description":
		"Generate high-quality PDFs in seconds. Perfect formatting, ready to send.",
	"landing.features.pdf.badge": "Professional PDF",

	"landing.features.multilang.title": "Multi-language",
	"landing.features.multilang.description":
		"Interface available in Portuguese (PT/BR), English, and Spanish. Create CVs in the language you need.",
	"landing.features.multilang.badge": "4 Languages",

	// Legacy features
	"landing.features.customization.title": "Full Customization",
	"landing.features.customization.description":
		"Choose colors, reorder sections and customize every detail",
	...
	"landing.templates.subtitle":
		"Choose from 3 modern designs, all optimized for ATS systems and ready to impress.",
	...
	"landing.templates.classic.features":
		"Clean layout,Professional font,Neutral colors",
	"landing.templates.professional.name": "Professional",
	"landing.templates.professional.description":
		"Serious look with refined typography",
	"landing.templates.professional.features":
		"Solid header,Typographic emphasis,Subtle accents",
	...
	"landing.templates.timeline.features":
		"Time rail,Visual milestones,Sequential reading",
	...
	"landing.templates.modern.features":
		"Minimalist design,Generous spacing,Modern typography",
	...
	"landing.templates.creative.features":
		"Vibrant colors,Unique layout,Visual elements",
	"landing.templates.minimal.name": "Minimal",
	"landing.templates.minimal.description":
		"Essential and straight to the point",
	"landing.templates.minimal.features":
		"Clean sidebar,Simple sections,Content-focused",
	"landing.templates.use.button": "Use Template",

	// How it works Section
	"landing.how.title": "Simple in 3 Steps",
	"landing.how.subtitle":
		"From zero to professional CV in minutes. Simple, fast, and effective.",
	"landing.how.step1.title": "Choose Template",
	"landing.how.step1.description":
		"Select one of the 3 professional templates that best suits your profile",
	"landing.how.step2.title": "Fill in Your Data",
	"landing.how.step2.description":
		"Add your information with intuitive forms and real-time preview",
	"landing.how.step3.title": "Download as PDF",
	"landing.how.step3.description":
		"Export your resume in high-quality PDF, ready to send",
	...
	"landing.testimonials.maria.quote":
		'"I created my CV in 10 minutes. The modern template was perfect!"',
	"landing.testimonials.joao.name": "João Santos",
	"landing.testimonials.joao.role": "Project Manager",
	"landing.testimonials.joao.quote":
		'"Very intuitive interface. I was able to customize everything easily."',
	"landing.testimonials.ana.name": "Ana Costa",
	"landing.testimonials.ana.role": "UX/UI Designer",
	"landing.testimonials.ana.quote":
		'"I loved the creative template. I stood out from the competition!"',

	// Open Source Section
	"landing.opensource.badge": "Open Source",
	"landing.opensource.title": "Open and Transparent Code",
	"landing.opensource.subtitle":
		"EasyPeasyCV is open source. The code is public, auditable, and built by the community. No surprises, no tricks.",
	"landing.opensource.contribute.button": "View on GitHub",
	"landing.opensource.support.button": "Support the Project",

	// CTA Section
	"landing.cta.title": "Ready to Create Your Professional CV?",
	"landing.cta.subtitle":
		"Join thousands of people who have already created their resume with EasyPeasyCV. Free, private, and hassle-free.",
	"landing.cta.button": "Create My CV Now",
	"landing.cta.note": "✓ No sign-up  ✓ 100% free  ✓ Private data",
	...
	"layout.controls.singlePageMode": "Super Compact",
	...
	"ats.explanation.how.description":
		"Follow these tips to increase your CV's chances of passing ATS filters:",
	"ats.explanation.how.tip1": "Use exact keywords from the job posting",
	"ats.explanation.how.tip2":
		"Keep a simple format, without graphics or tables",
	"ats.explanation.how.tip3":
		'Use standard headers like "Professional Experience" and "Education"',
	...
	"ats.explanation.template.description":
		"For maximum compatibility with ATS systems, we recommend the classic template, which was specifically designed to pass automatic filters.",
	...
	"ats.explanation.action.description":
		"Learn about ATS systems and how to optimize your CV",
