...
const brTranslations: Record<string, string> = {
  ...
  'template.professional.description': 'Cabeçalho centralizado com espaçamento equilibrado',
  ...
  'template.classic.description': 'Layout em coluna única, otimizado para sistemas ATS',
